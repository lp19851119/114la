<?php
//网站url
$siteUrl = str_replace(array($_SERVER['DOCUMENT_ROOT']), array('https://'.$_SERVER['HTTP_HOST']), dirname(dirname($_SERVER['SCRIPT_FILENAME'])));
defined('SITE_URL') or define('SITE_URL',$siteUrl.'/'); //http://xxxi.com/

//网站管理后台的url
$siteBackendUrl = str_replace(array($_SERVER['DOCUMENT_ROOT'],'/index.php'), array('https://'.$_SERVER['HTTP_HOST'],'/'), $_SERVER['SCRIPT_FILENAME']);
